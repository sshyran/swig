...
(function (window) {
  ...
  /*
   * Overrides _.before which allows us to pass an object to any _.once'd
   * function instructing it to reset to allow us to call it again.
   * eg. cart.init({ __reset: true });
   */
  gilt.require(['vendor.underscore'], function (_) {
