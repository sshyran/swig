...
const swig = {
  ...
  get browserslist() {
    ...
    // A default list of browsers that should be supported in the front end app,
    // based on https://github.com/ai/browserslist
    // This can be overridden locally in the target App by
    // adding a `"browserslist"` field in its own `package.json`
